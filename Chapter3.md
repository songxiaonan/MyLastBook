...
### AKF扩展立方
 ...
 AKF是Marty Abbott、Tom Keeven和Michael Fisher
...
最后需要说的是，康威还是协程的发明者，如果你使用Go语言、熟悉Goroutines或者是其他编程语言的类似机制，康威可以算作是这类机制的鼻祖，得知此事，想必你会对康威钦佩有加，他的发现和发明，分别在宏观层面和微观层面对软件行业产生了深远的影响。