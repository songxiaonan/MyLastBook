...
在“理念二：协作优先，文本通讯”中我们曾提到使用粗粒度的接口隔离相互协作的程序的内部状态，这在微服务开发中是个非常基本的要求，更进一步的，每个微服务对应的开发团队都应该为其所负责开发的微服务建立强约束力的服务契约，并尽可能的将与其他团队的沟通限制在服务契约层面，每个团队可以安排一到两位专家负责与其他团队商讨服务契约的制定和维护，在遵守服务契约的前提下，各团队对微服务的内部实现上拥有充分的自主权，

团队之间不应该在微服务的内部实现上做出妥协。
