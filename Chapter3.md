...
上个世纪六十年代，著名计算机科学家、协程的发明者梅尔文·康威（Melvin Conway）在其职业生涯中观察到了一个有趣的现象：软件产品的架构在很大程度上会反映其开发团队的组织架构。后来康威将其推广为一种社会学观察，并撰为其写了一篇名为“How Do Committees Invent?”的论文，其思想一般被概括为：
