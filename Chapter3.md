...
这是出现在半个世纪之前的古老定律，随着微服务模式的流行，该定律重获新生，并前所未有的走入公众视野，网上到处充斥着有关康威定律的文章，想必您也读到过一些。该定律对微服务模式来说如此重要，以至于本书也不能免俗和避而不谈。

计算机科学家梅尔文·康威（Melvin Conway）在其职业生涯中观察到了一个有趣的现象：软件产品的架构在很大程度上会反映其开发团队的组织架构。后来康威将其推广为一种社会学观察，原文是：

>任何设计系统的组织，必然会产生以下设计结果：该系统的结构就是该组织沟通结构的写照。

简单的说：产品结构是其组织沟通结构的缩影。这里的系统或者产品，指的是广义上的系统和产品，并不仅仅是软件。投资家彼得·蒂尔（Peter Thiel）在其著作《从0到1》中曾提到网络电视遥控器的例子：遥控器的点播键又大又醒目，而静音键又小又难找，只是因为点播业务是该企业的主要收入来源，而没人能从静音上赚到钱，这也是企业组织架构影响产品设计的典型案例。
